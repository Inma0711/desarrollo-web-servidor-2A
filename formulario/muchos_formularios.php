...
<h1>FORMULARIO M�XIMO DE 3 N�MEROS</h1>
...
<form action="" method="post">
    <fieldset>
        <label for="nPrimos">N�mero de primos: </label>
        <br>
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST") {
            if($_POST["action"] == "primos") {
                ...
                echo "Los " . $numeroPrimos . " primeros n�meros primos son: ";
